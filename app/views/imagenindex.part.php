    ...
    <div class="row popup-gallery">
        <?php foreach ($imagenesHome as $imagen) : ?>
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="sol">
                    <img class="img-responsive" src="<?= 'uploads/portfolio/' . $imagen->getNombre() ?>" alt="First category picture">
                    <div class="behind">
                        <div class="head text-center">
                            <ul class="list-inline">
                                <li>
                                    <a class="gallery" href="<?= 'uploads/galeria/' . $imagen->getNombre() ?>" data-toggle="tooltip" data-original-title="Quick View">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </li>
                                <li>
