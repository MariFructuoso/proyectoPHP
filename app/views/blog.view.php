    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-8 row">
        <div class="col-xs-12 col-sm-12">
          <div class="post">
            <div class="post-heading">
              <span>6 JANUARY</span>
              <img class="img-responsive" src="<?php echo 'images/blog/landscape.jpg'; ?>" alt="post's picture">
            </div>
            <div class="post-body">
              <h3><a href="<?php echo 'single_post.php'; ?>"><strong>doloremque illum</strong></a></h3>
              <hr>
            ...
            <div class="post-footer">
              <a class="btn" href="<?php echo 'single_post.php'; ?>">READ MORE...</a>
              <span>
        ...
        <div class="col-xs-12 col-sm-12">
          <div class="post">
            <div class="post-heading">
              ...
              <img class="img-responsive" src="<?php echo 'images/blog/family.jpg'; ?>" alt="post's picture">
            </div>
            <div class="post-body">
              <h3><a href="<?php echo 'single_post.php'; ?>"><strong>Lorem ipsum</strong></a></h3>
              <hr>
        ...
        <div class="col-xs-12 col-sm-12">
          <div class="post">
            <div class="post-heading">
              <span>8 MARCH</span>
              <img class="img-responsive" src="<?php echo 'images/blog/elephant.jpg'; ?>" alt="post's picture">
            </div>
            <div class="post-body">
              <h3><a href="<?php echo 'single_post.php'; ?>"><strong>Aliquam soluta</strong></a></h3>
              <hr>
      ...
      <div class="col-xs-12 col-sm-4">
        ...
        <div class="post">
          <div class="post-heading">
            <span>10 APRIL</span>
            <img class="img-responsive" src="<?php echo 'images/blog/wedding.jpg'; ?>" alt="post's picture">
          </div>
          <div class="post-body">
            <span>
            <i class="fa fa-heart sr-icons"></i> 10
            ...
            <h4 class="text-left"><a href="<?php echo 'single_post.php'; ?>"><strong>Aliquam soluta</strong></a></h4>
          </div>
        </div>
        ...
        <div class="post">
          <div class="post-heading">
            <span>12 MAY</span>
            <img class="img-responsive" src="<?php echo 'images/blog/woman.jpg'; ?>" alt="post's picture">
          </div>
          <div class="post-body">
            <span>
            <i class="fa fa-heart sr-icons"></i> 10
            ...
            <h4 class="text-left"><a href="<?php echo 'single_post.php'; ?>"><strong>Consequuntur</strong></a></h4>
          </div>
        </div>
      </div>
      <!-- End of Side bar --> 
